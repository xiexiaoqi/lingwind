...
include( CROOT . 'lib' . DS . 'core.function.php' );
@include( AROOT . 'lib' . DS . 'app.function.php' );

include( CROOT . 'config' .  DS . 'core.config.php' );
include( AROOT . 'config' . DS . 'app.config.php' );
